...
// </auto-generated>
//------------------------------------------------------------------------------
public sealed class ApplyJumpEventSystem : Entitas.ReactiveSystem<GameStateEntity> {

    readonly Entitas.IGroup<GameStateEntity> _listeners;
    readonly System.Collections.Generic.List<GameStateEntity> _entityBuffer;
    readonly System.Collections.Generic.List<IApplyJumpListener> _listenerBuffer;

    public ApplyJumpEventSystem(Contexts contexts) : base(contexts.gameState) {
        ...
        _listenerBuffer = new System.Collections.Generic.List<IApplyJumpListener>();
    }

    protected override Entitas.ICollector<GameStateEntity> GetTrigger(Entitas.IContext<GameStateEntity> context) {
        return Entitas.CollectorContextExtension.CreateCollector(
            context, Entitas.TriggerOnEventMatcherExtension.Added(GameStateMatcher.ApplyJump)
        );
    }
